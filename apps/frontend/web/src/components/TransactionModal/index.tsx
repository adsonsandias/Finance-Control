...
export function TransactionModal({ isOpen, onRequestClose }: ITRANSACTIONMODALPROPS) {
  ...
  const handleSubmitTransaction = React.useCallback(
    ...
    [title, type, category, amount, createTransaction, loadTransactions, onRequestClose]
  )
    ...
    >
      ...
      >
        ...
        <Container onSubmit={handleSubmitTransaction}>
          ...
          <input type="number" placeholder="Valor" value={amount} onChange={handleAmountChange} />
