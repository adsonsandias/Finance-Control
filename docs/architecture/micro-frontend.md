...
### 1. Authentication Module (`frontend/web/`)
...
### 2. Dashboard Module (`frontend/mobile/`)

- **Purpose**: Main application mobile
- **Port**: 3001
- **Features**:
  - Financial overview
...
docker-compose up frontend-mobile backend db
...
- JWT tokens are managed by the web module
